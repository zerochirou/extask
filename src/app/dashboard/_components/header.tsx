  ...
  return (
    <header className={`mb-4`}>
      <div className="relative">
        ...
        <div className="relative">
          <div className="flex sm:flex-row flex-col items-center justify-between mb-4 gap-2">
            <div>
            ...
            <div className="flex flex-wrap items-center sm:gap-4 gap-2">
              <Card className="flex flex-row items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/30 to-accent/10 border-none shadow-none">
